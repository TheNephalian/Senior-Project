...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.numRoundsLabel.setText(_translate("MainWindow", str(numRounds)))
        self.winPercentageLabel.setText(_translate("MainWindow", str((numRoundsWon/numRounds)*100)+"%"))
        self.label.setText(_translate("MainWindow", "Results"))
        self.numRoundsLostLabel.setText(_translate("MainWindow", str(numRoundsLost)))
