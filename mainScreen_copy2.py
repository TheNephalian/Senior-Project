...
class Ui_MainWindow(object):
    ...
    def open_window(self):
        ...
        if(self.checkBox_45.isChecked()):
            typeofcreature = self.checkBox_45.text()
        elif(self.checkBox_51.isChecked()):
            typeofcreature = self.checkBox_51.text()
        elif(self.checkBox_49.isChecked()):
            typeofcreature = self.checkBox_49.text()
        elif(self.checkBox_48.isChecked()):
            typeofcreature = self.checkBox_48.text()
        elif(self.checkBox_46.isChecked()):
            typeofcreature = self.checkBox_46.text()
        elif(self.checkBox_47.isChecked()):
            typeofcreature = self.checkBox_47.text()
        elif(self.checkBox_50.isChecked()):
            typeofcreature = self.checkBox_50.text()
        elif(self.checkBox_52.isChecked()):
            typeofcreature = self.checkBox_52.text()
        elif(self.checkBox_53.isChecked()):
            typeofcreature = self.checkBox_53.text()
        elif(self.checkBox_54.isChecked()):
            typeofcreature = self.checkBox_54.text()
        elif(self.checkBox_55.isChecked()):
            typeofcreature = self.checkBox_55.text()
        elif(self.checkBox_56.isChecked()):
            typeofcreature = self.checkBox_56.text()
        elif(self.checkBox_57.isChecked()):
            typeofcreature = self.checkBox_57.text()
        elif(self.checkBox_58.isChecked()):
            typeofcreature = self.checkBox_58.text()
        elif(self.checkBox_59.isChecked()):
            typeofcreature = self.checkBox_59.text()
        self.ui.label_30.setText(typeofcreature)
        align = self.comboBox.currentText()
        self.ui.label_29.setText(align)
        traits = ""
        if(self.checkBox_3.isChecked()):
            if(traits == ""):
                traits += self.checkBox_3.text()
            else:
                traits += ", "
                traits += self.checkBox_3.text()
        if(self.checkBox_4.isChecked()):
            if(traits == ""):
                traits += self.checkBox_4.text()
            else:
                traits += ", "
                traits += self.checkBox_4.text()
        if(self.checkBox_8.isChecked()):
            if(traits == ""):
                traits += self.checkBox_8.text()
            else:
                traits += ", "
                traits += self.checkBox_8.text()
        if(self.checkBox_11.isChecked()):
            if(traits == ""):
                traits += self.checkBox_11.text()
            else:
                traits += ", "
                traits += self.checkBox_11.text()
        if(self.checkBox_18.isChecked()):
            if(traits == ""):
                traits += self.checkBox_18.text()
            else:
                traits += ", "
                traits += self.checkBox_18.text()
        if(self.checkBox_15.isChecked()):
            if(traits == ""):
                traits += self.checkBox_15.text()
            else:
                traits += ", "
                traits += self.checkBox_15.text()
        if(self.checkBox_20.isChecked()):
            if(traits == ""):
                traits += self.checkBox_20.text()
            else:
                traits += ", "
                traits += self.checkBox_20.text()
        if(self.checkBox_23.isChecked()):
            if(traits == ""):
                traits += self.checkBox_23.text()
            else:
                traits += ", "
                traits += self.checkBox_23.text()
        if(self.checkBox_27.isChecked()):
            if(traits == ""):
                traits += self.checkBox_27.text()
            else:
                traits += ", "
                traits += self.checkBox_27.text()
        if(self.checkBox_26.isChecked()):
            if(traits == ""):
                traits += self.checkBox_26.text()
            else:
                traits += ", "
                traits += self.checkBox_26.text()
        if(self.checkBox_25.isChecked()):
            if(traits == ""):
                traits += self.checkBox_25.text()
            else:
                traits += ", "
                traits += self.checkBox_25.text()
        if(self.checkBox_24.isChecked()):
            if(traits == ""):
                traits += self.checkBox_24.text()
            else:
                traits += ", "
                traits += self.checkBox_24.text()
        if(self.checkBox_22.isChecked()):
            if(traits == ""):
                traits += self.checkBox_22.text()
            else:
                traits += ", "
                traits += self.checkBox_22.text()
        if(self.checkBox_21.isChecked()):
            if(traits == ""):
                traits += self.checkBox_21.text()
            else:
                traits += ", "
                traits += self.checkBox_21.text()
        if(self.checkBox_19.isChecked()):
            if(traits == ""):
                traits += self.checkBox_19.text()
            else:
                traits += ", "
                traits += self.checkBox_19.text()
        if(self.checkBox_17.isChecked()):
            if(traits == ""):
                traits += self.checkBox_17.text()
            else:
                traits += ", "
                traits += self.checkBox_17.text()
        if(self.checkBox_16.isChecked()):
            if(traits == ""):
                traits += self.checkBox_16.text()
            else:
                traits += ", "
                traits += self.checkBox_16.text()
        if(self.checkBox_14.isChecked()):
            if(traits == ""):
                traits += self.checkBox_14.text()
            else:
                traits += ", "
                traits += self.checkBox_14.text()
        if(self.checkBox_12.isChecked()):
            if(traits == ""):
                traits += self.checkBox_12.text()
            else:
                traits += ", "
                traits += self.checkBox_12.text()
        if(self.checkBox_10.isChecked()):
            if(traits == ""):
                traits += self.checkBox_10.text()
            else:
                traits += ", "
                traits += self.checkBox_10.text()
        if(self.checkBox_9.isChecked()):
            if(traits == ""):
                traits += self.checkBox_9.text()
            else:
                traits += ", "
                traits += self.checkBox_9.text()
        if(self.checkBox_7.isChecked()):
            if(traits == ""):
                traits += self.checkBox_7.text()
            else:
                traits += ", "
                traits += self.checkBox_7.text()
        if(self.checkBox_5.isChecked()):
            if(traits == ""):
                traits += self.checkBox_5.text()
            else:
                traits += ", "
                traits += self.checkBox_5.text()
        if(self.checkBox_6.isChecked()):
            if(traits == ""):
                traits += self.checkBox_6.text()
            else:
                traits += ", "
                traits += self.checkBox_6.text()
            
        self.ui.label_34.setText(traits)
        resOrimmu = self.resComboBox.currentText()
        self.ui.label_33.setText(resOrimmu)
        langues = ""
        if(self.checkBox_43.isChecked()):
            if(langues == ""):
                langues += self.checkBox_43.text()
            else:
                langues += ", "
                langues += self.checkBox_43.text()
        if(self.checkBox_42.isChecked()):
            if(langues == ""):
                langues += self.checkBox_42.text()
            else:
                langues += ", "
                langues += self.checkBox_42.text()
        if(self.checkBox_41.isChecked()):
            if(langues == ""):
                langues += self.checkBox_41.text()
            else:
                langues += ", "
                langues += self.checkBox_41.text()
        if(self.checkBox_40.isChecked()):
            if(langues == ""):
                langues += self.checkBox_40.text()
            else:
                langues += ", "
                langues += self.checkBox_40.text()
        if(self.checkBox_39.isChecked()):
            if(langues == ""):
                langues += self.checkBox_39.text()
            else:
                langues += ", "
                langues += self.checkBox_39.text()
        if(self.checkBox_38.isChecked()):
            if(langues == ""):
                langues += self.checkBox_38.text()
            else:
                langues += ", "
                langues += self.checkBox_38.text()
        if(self.checkBox_37.isChecked()):
            if(langues == ""):
                langues += self.checkBox_37.text()
            else:
                langues += ", "
                langues += self.checkBox_37.text()
        if(self.checkBox_36.isChecked()):
            if(langues == ""):
                langues += self.checkBox_36.text()
            else:
                langues += ", "
                langues += self.checkBox_36.text()
        if(self.checkBox_35.isChecked()):
            if(langues == ""):
                langues += self.checkBox_35.text()
            else:
                langues += ", "
                langues += self.checkBox_35.text()
        if(self.checkBox_34.isChecked()):
            if(langues == ""):
                langues += self.checkBox_34.text()
            else:
                langues += ", "
                langues += self.checkBox_34.text()
        ...
        self.ui.label_31.setText(str(numAttks2))
...
"background-color: rgb(153, 184, 152);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_48.setText(_translate("MainWindow", "Chuul"))
        self.checkBox_46.setText(_translate("MainWindow", "Beast"))
        self.checkBox_47.setText(_translate("MainWindow", "Celestial"))
